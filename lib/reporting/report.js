 ...
 *   a `Monitor` or `MonitorGroup` using `updateFromMonitor()`/`updateFromMonitorGroup()`.
 *
...
var ReportGroup = exports.ReportGroup = function() {
    ...
    Object.defineProperty(this, 'logBaseDir', {
        get: function() {
            "use strict";
            return this._logBaseDir || '';
        },
        set: function(val) {
            this._logBaseDir = val;
        }
    });

    Object.defineProperty(this, 'logNameOrObject', {
        get: function() {
            this._logFile = this._logFile || 'results-' + config.start.toISOString() + '.html';
            return  path.join(this.logBaseDir, this._logFile);
        },
...
ReportGroup.prototype = {
    ...
    getReport: function(report) {
        var reports = this.reports.filter(function(r) {
            return r.name === report;
        });
    ...
    setReportBaseDir: function(dir) {
        this.logBaseDir = dir;
        var checkDir = this.logBaseDir;
