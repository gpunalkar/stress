 ...
 *
 * @param statsNames contain names of the statistics to track. Register more statistics by extending
...
MonitorGroup.prototype.__proto__ = EventEmitter.prototype;

/**
 * Pre-initialize monitors with the given names. This allows construction overhead to take place all at once if desired.
 */
...
MonitorGroup.prototype.update = function() {
    ...
    util.forEach(this.monitors, function(name, m) {
        m.update();
    });
};