...
exports.disableLogs = function() {
 ...
 /**
  * Sets the base reporting and logging directory
  *
  * @param dir A base directory into which logs and html reports will be stored
  * @returns {Object}
  */
exports.setBaseDir = function(dir){
    NODELOAD_CONFIG.REPORT_DIR = dir||'';
    return exports;
};
...
var NODELOAD_CONFIG = exports.NODELOAD_CONFIG = {
    REPORT_DIR: path.join(process.env.HOME, '.config/stress'),
