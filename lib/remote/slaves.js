...
Slaves.prototype.__proto__ = EventEmitter.prototype;
...
Slaves.prototype.add = function(hostAndPort) {
    ...
    self[id].on('start', function() {
        var allStarted = util.every(self.slaves, function(id, s) {
    ...
    self[id].on('end', function() {
        var allStopped = util.every(self.slaves, function(id, s) {
            return s.state !== 'started';
        });
        if (!allStopped) {
            return;
...
Slaves.prototype.defineMethod = function(name, fun) {
    ...
    self[name] = function() {
        var args = arguments;
        return self.slaves.map(function(s) {
