...
var Slave = exports.Slave = function Slave(id, host, port, masterEndpoint, pingInterval) {
    ...
    this.pingInterval = pingInterval || config.settings.slaveUpdateInterval;
    this.methodDefs = [];
    this.state = 'initialized';
};
Slave.prototype.__proto__ = EventEmitter.prototype;
...
Slave.prototype.defineMethod = function(name, fun) {
    ...
    self[name] = function() {
        return self.client[name].apply(self.client, arguments);
    };
