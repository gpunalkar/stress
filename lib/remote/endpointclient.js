...
var DEFAULT_RETRY_INTERVAL_MS = 2000,
    HttpRequest = HttpRequest || require('../http').HttpRequest;
...
var EndpointClient = exports.EndpointClient = function EndpointClient(host, port, basepath) {
    ...
    this.host = host;
    this.port = port;
    this.client = new HttpRequest(port, host);
...
EndpointClient.prototype.__proto__ = EventEmitter.prototype;
...
/**
 * Add a method that the target server understands. The method can be executed by calling `endpointClient.method(args...)`.
 */
